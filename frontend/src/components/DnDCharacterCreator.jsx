  ...
  const generateCharacter = async () => {
    ...
    try {
      ...
      const dndRequest = {
        ...
        generate_narrative: false, // We'll handle narrative separately
      };
      ...
      // Step 2: Generate AI narrative aspects if enabled
      if (useAINarrative) {
        const narrativeEnhancements =
          await generateNarrativeEnhancements(character);
        character.ai_narrative = narrativeEnhancements;
      }

      // Step 3: Generate portrait if enabled
