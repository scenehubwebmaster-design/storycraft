...
function CombatTracker({
  ...
  const handleOpenAttackDialog = () => {
    ...
    const firstEnemy = combatants.find(
      (c, idx) => idx !== current_turn && c.name !== currentTurnCombatant?.name
    );
    if (firstEnemy) {
  ...
  return (
    <>
      <Paper elevation={3} sx={{ overflow: "hidden" }}>
        ...
        >
          <Box>
            ...
            <Typography variant="caption">Round {round}</Typography>
          </Box>
          <IconButton
            size="small"
            onClick={onEndCombat}
                  ...
                  <Box sx={{ width: "100%" }}>
                    ...
                    >
                      ...
                      >
                        <Typography
                          variant="subtitle1"
                          sx={{ fontWeight: isCurrentTurn ? "bold" : "normal" }}
                        >
                          {combatant.name}
                        </Typography>
                        {isCurrentTurn && (
      ...
      >
        <DialogTitle>Select Attack Target</DialogTitle>
