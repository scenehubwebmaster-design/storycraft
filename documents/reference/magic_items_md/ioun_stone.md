...
**Category & Rarity.** Wondrous item, rarity varies (requires attunement)
...
Reserve (Rare). This vibrant purple prism stores spells cast into it, holding them until you use them. The stone can store up to 3 levels worth of spells at a time. When found, it contains 1d4 â 1 levels of stored spells chosen by the GM.
